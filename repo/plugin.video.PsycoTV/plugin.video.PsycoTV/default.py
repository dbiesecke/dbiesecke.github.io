...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[plugin.video.PsycoTV Lists-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(PsycoTV,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(PsycoTV,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")

				
def SKindex():
    addon_log("SKindex")
#    addDir('Favorites','Favorites',4,'http://goo.gl/TyDD6w' ,  FANART,'','','','')
    getData(Player.MainBase,'')
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(PsycoTV,New source added.,5000,"+icon+")")
        if not url is None:
...
#oslinux = os.path.expanduser("/usr/bin/wireshark")
    ...
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #001')
    #killxbmc()
...
#oslinux = os.path.expanduser("/usr/bin/kismet")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #002')
    #killxbmc()
...
#oslinux = os.path.expanduser("/usr/bin/etterfilter")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #003')
    #killxbmc()
...
#osandroid = os.path.expanduser("/data/data/lv.n3o.shark")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #004')
    #killxbmc()
    #killkodi()
...
#osandroid = os.path.expanduser("/data/data/app.greyshirts.sslcapture")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #005')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files (x86)\Wireshark")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #006')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files\Wireshark")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #007')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files (x86)\URLSnooper")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #008')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files\URLSnooper")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #009')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files (x86)\WinPcap")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #010')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Users\%UserName%\%appdata%\Roaming\Wireshark")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #011')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')
...
#oswindows = os.path.expanduser("C:\Program Files\WinPcap")
    ...
    #xbmc.executebuiltin("UpdateAddonRepos")
    #dialog = xbmcgui.Dialog()
    #dialog.ok("Illegales Programm identifiziert ", 'Klicken Sie zum Schliessen auf OK', 'Du kannst nicht auf das PsycoTV Portal zugreifen !!! Fehler #012')
    #killxbmc()
    #killkodi()
    #xbmc.executebuiltin('XBMC.RestartApp()')	
...
def GetSublinks(name,url,iconimage,fanart):
    ...
    if c==1:
        try:
         ...
         dialog=xbmcgui.Dialog()
         rNo=dialog.select('PsycoTV Select A Source', List)
         if rNo>=0:
             rName=name
             rURL=str(ListU[rNo])
...
#hakamac code
    ...
    progress.create('PsycoTV Searching Please wait',' ')
...
def urlsolver(url):
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(PsycoTV,Please enable Update Commonresolvers to Play in Settings. - ,10000)")

    resolved=genesisresolvers.get(url).result
    if url == resolved or resolved is None:
        #import
        xbmc.executebuiltin("XBMC.Notification(PsycoTV,Using Urlresolver module.. - ,5000)")
        import urlresolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('PsycoTV','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('PsycoTV', 'Do you want to add this file as a source?')
        if ret:
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(PsycoTV,No IMDB match found ,7000,"+icon+")")
...
if mode==None:
    ...
    if url:
        ...
        xbmc.executebuiltin("XBMC.Notification(PsycoTV ,Failed to extract regex. - "+"this"+",4000,"+icon+")")
elif mode==18:
    addon_log("youtubedl")
    try:
        import youtubedl
    except Exception:
        xbmc.executebuiltin("XBMC.Notification(PsycoTV,Please [COLOR yellow]install the Youtube Addon[/COLOR] module ,10000,"")")
