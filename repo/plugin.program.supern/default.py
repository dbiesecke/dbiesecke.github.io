...
def viewBuild(name):
	...
	if wiz.checkBuild(name, 'version') == False: 
		...
		return
	keyboard = xbmc.Keyboard('','Passworteingabe')
	keyboard.setHiddenInput(True)
	keyboard.doModal()
	if (keyboard.isConfirmed()):
		s='687474703a2f2f53696d706c654b6f72652e636f6d2f7a796a7361782f4172742f70617373776f72642e7068703f616374696f6e3d636865636b7061737326706173733d'
		z='http://www.notjust4nerds.de/Kodi/Auth/password.php?action=checkpass&pass='; passwordcheckurl=z+str(keyboard.getText())
		req = urllib2.Request(passwordcheckurl)
		response = urllib2.urlopen(req)	
		passwordvalid = response.read()
		if passwordvalid == "Yes":
			...
			dialog = xbmcgui.Dialog()
			dialog.ok('Error!', "[COLOR red]Falsches[/COLOR] Passwort!")
	else:
		dialog = xbmcgui.Dialog()
		dialog.ok('Ops!', "Something went wrong! Contact us for support.")
	setView('files', 'viewType')
