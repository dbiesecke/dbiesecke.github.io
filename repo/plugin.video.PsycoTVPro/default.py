...
#############Defined Strings#############
icon         = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PsycoTVPro/icon.png'))
fanart       = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PsycoTVPro/fanart.jpg'))
...
def start():
    ...
    if not request.status_code == 200:
        yesnowindow = xbmcgui.Dialog().yesno('PsycoTV Pro', 'PsycoTV Pro Aktivierung: ','','Willst du PsycoTV Pro aktivieren?', yeslabel='Ja',nolabel='Nein')
        ...
        if yesnowindow == 1:
	        ...
	        dialog.ok('PsycoTV Pro','Aktivierung abgebrochen.','')
...
def correctPVR():
    ...
    PVRVOR = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PsycoTVPro/settingsvor.xml'))
    ...
    M3UNEW = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PsycoTVPro/favnew.m3u'))
